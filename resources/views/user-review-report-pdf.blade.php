...
<tr>
    ...
    <td style="text-align: center" align="center">
        <img src="{{(env("APP_URL") . '/' . $restaurant['Logo'])}}" alt="logo" style="text-align: center; height:50px; widht:50px" height="50" width="50">
...
<tr>
    ...
    <td width="25"></td>
            ...
            <table width="100%" style=" margin-left: auto; margin-right: auto;  text-align: center; background:#172C41; border-radius: 10px;">
                <tbody>
                    <tr>
                        <td rowspan="2" style="font-size: 40px; font-weight: bolder; height: 80px; color:#fff;">{{$restaurant["Name"]}}</td>
                        <td width="50%">
                            <div>
                                <table>
                                    <td colspan="25">
