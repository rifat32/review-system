...
class ReviewNewController extends Controller
{
    ...
    // ##################################################
      ...
      /**
        *
     * @OA\Get(
     *      path="/review-new/getvalues/{restaurantId}/{rate}",
...
* ),
    ...
    // ##################################################
        ...
        *
     * @OA\Get(
     *      path="/review-new/getavg/review/{restaurantId}/{start}/{end}",
...
* ),
   ...
   /**
        *
     * @OA\Get(
     *      path="/review-new/getreview/{restaurantId}/{rate}/{start}/{end}",
...
* ),
    ...
    // ##################################################
     /**
        *
     * @OA\Get(
     *      path="/review-new/getreviewAll/{restaurantId}",
...
* ),
    ...
    // ##################################################
     ...
     /**
        *
     * @OA\Get(
     *      path="/review-new/getcustomerreview/{restaurantId}/{start}/{end}",
    ...
    *  {"question_id":2,"tag_id":1,"star_id":4},
    ...
    // ##################################################
     /**
        *
     * @OA\Post(
     *      path="/review-new-guest/{restaurantId}",
...
*
  *       security={
    ...
    *  {"question_id":2,"tag_id":1,"star_id":4},
    ...
    public function storeReviewByGuest($restaurantId,  Request $request)
    {
    ...
    *       security={
     ...
     *         required=true,
     *         @OA\JsonContent(
     *            required={"question","restaurant_id","is_active"},
    ...
    public function storeQuestion(Request $request)
    {
        ...
        if ($request->user()->hasRole("superadmin")) {
            ...
            $question["restaurant_id"] = NULL;
        } else {

            $restaurant =    Restaurant::where(["id" => $request->restaurant_id,"OwnerID" => $request->user()->id])->first();
 ...
 *         @OA\Parameter(
    ...
    {
        $is_dafault = false;
        $restaurantId = !empty($request->restaurant_id)?$request->restaurant_id:NULL;
        if ($request->user()->hasRole("superadmin")) {
        ...
        $query =  Question::where(["restaurant_id" => $restaurantId,"is_default" => $is_dafault]);
 ...
 *         @OA\Parameter(
    ...
    public function   getQuestionAllUnauthorized(Request $request)
    {
        $is_dafault = false;
            ...
            // }
            // else {
                $query =  Question::where(["restaurant_id" => $request->restaurant_id,"is_default" => 0])
...
$data2["total_comment"] = $data2["total_comment"]->get();
    ...
    if($starTag->question_id == $questions->id) {
        ...
        *
     * @OA\Get(
     *      path="/review-new/get/questions/{id}/{restaurantId}",
    ...
    public function   getQuestionById2($id,$restaurantId, Request $request)
    {
        $questions =    Question::where(["id" => $id,"restaurant_id"=>$restaurantId])
            ->first();
    ...
    *       security={
    ...
    public function storeTag(Request $request)
    {
     ...
     /**
        *
     * @OA\Post(
     *      path="/review-new/create/tags/multiple/{restaurantId}",
 ...
 * "tag1","tag2"
     ...
     *     )
     */
    public function storeTagMultiple($restaurantId,Request $request)
    {
        ...
        foreach($uniqueTags as $index=>$tag) {
         ...
         if($tag_found) {
            ...
            array_push($duplicate_indexes_array,$index);
                ...
                $tag_found =    Tag::where(["restaurant_id" => $restaurantId,"is_default" => 0,"tag" => $question["tag"]])
         ...
         if($tag_found) {
            ...
            $tag_found =    Tag::where(["restaurant_id" => NULL,"is_default" => 1,"tag" => $question["tag"]])
            ->first();
            if($tag_found) {
    ...
    *       security={
    ...
    public function   getTag(Request $request)
    {
        ...
        if ($request->user()->hasRole("superadmin")) {
            $is_dafault = true;
            $restaurantId = NULL;
            $query =  Tag::where(["restaurant_id" => NULL,"is_default" => true])
            ->when(request()->filled("is_active"), function($query) {
            ...
            //     $is_dafault = true;
            // }
            $query =  Tag::where(["restaurant_id" => $restaurantId,"is_default" => 0])
            ->orWhere(["restaurant_id" => NULL,"is_default" => 1])
            ->when(request()->filled("is_active"), function($query) {
                $query->where("tags.is_active",request()->input("is_active"));
             });;
        }
    ...
    {
        $questions =    Tag::where(["id" => $id,"restaurant_id" => $reataurantId])
            ->first();
            if(!$questions) {
                return response([
                    "message" => "No Tag Found"
    ...
    // ##################################################
    public function   getSelectedTagCount($restaurantId , Request $request)
    {

        $questions =    Question::where(["restaurant_id" => $restaurantId])
            ->get();
        $data =  json_decode(json_encode($questions), true);
        foreach($questions as $key1=>$question){
 ...
 *         @OA\Parameter(
    ...
    public function getQuestionAllReportGuestQuantum(Request $request) {
        ...
        if(!$restaurant){
            return response("No Business Found or you are not the owner of the restaurant", 404);
        }
$data = [];
...
for($i = 0;$i < count($users->items());$i++ ){
    ...
    ->where([
        "questions.restaurant_id" => $request->restaurant_id,
